...
The first line: âC is funâ
The second line: âPython is coolâ
The third line: âJavaScript is amazingâ
You must use console.log(...) to print all output
You are not allowed to use var
...
If only one argument is passed to the script, print âArgument foundâ
Otherwise, print âArguments foundâ
You must use console.log(...) to print all output
You are not allowed to use var
